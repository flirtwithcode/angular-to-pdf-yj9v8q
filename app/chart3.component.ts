    ...
    tooltips: {
      ...
      custom: function (tooltipModel) {
        ...
        if (htmlDom == null) {
          ...
          <br/>`,
            `
          <div style='margin:-20% 0 0 0;color:#FFFFFF'> tt</div><br/><div style=' height:80px;width:160px;background-color: #fce7ce;color: #000;padding: 10px;'><span style="background: #4f86f7;border-radius: 30px;color: #fff;content: attr(badge);font-size: 11px;min-width: 20px;padding: 2px;position: absolute;text-align: center;margin: 4% 0% 0% -15%;">3</span>Determine if<br>payment is fraud;<br>cancel payment if<br>fraud</div><br>`,

            `<div style='margin:-10% 0 0 0; height:70px;width: 165px;background-color: #ddc4f0;color: #000;padding: 10px;'>Payment made- <br>	Payment file are sent <br> for debit</div><br/>
          <div style=' height:80px;width: 165px;background-color: #ddc4f0;color: #000;padding: 10px;'><span style="background: #4f86f7;border-radius: 30px;color: #fff;content: attr(badge);font-size: 11px;min-width: 20px;padding: 2px;position: absolute;text-align: center;margin: 4% 0% 0% -15%;">5</span>Payment files are sent <br/>from FISERV to Bank of <br>America</div>`,

            `<div style='margin:-50% 0 0 0; height:80px;width: 155px;background-color: #f7f1fb;color: #000;padding: 10px;'><span style="background: green;border-radius: 30px;color: #fff;content: attr(badge);font-size: 11px;min-width: 20px;padding: 2px;position: absolute;text-align: center;margin: 4% 0% 0% -15%;">5</span>Perform General Ledger <br><span style="background: green;border-radius: 30px;color: #fff;content: attr(badge);font-size: 11px;min-width: 20px;padding: 2px;position: absolute;text-align: center;margin: 4% 0% 0% -15%;">6</span>Reconciliation</div>`,
          ];
